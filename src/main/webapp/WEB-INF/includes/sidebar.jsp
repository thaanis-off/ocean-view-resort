...
<aside class="w-64 bg-gray-900 border-r border-gray-800 flex flex-col">
    ...
    <nav class="flex-1 px-4 py-6 space-y-1 overflow-y-auto">
        ...
        <a href="${pageContext.request.contextPath}/staff?action=list" 
           class="flex items-center px-4 py-3 text-sm font-medium rounded-lg transition-colors ${param.activePage == 'staff' ? 'text-white bg-gray-800' : 'text-gray-300 hover:bg-gray-800 hover:text-white'}">
            <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
